...
{
    /// <inheritdoc />
    public partial class updateModelOfRecipeAgain : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DaysOfCure = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RecipeIngredients_WarehouseItems_WarehouseItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecipeIngredients_WarehouseItemId",
                table: "RecipeIngredients",
